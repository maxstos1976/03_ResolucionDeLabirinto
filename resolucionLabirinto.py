...
#  Puedes usar una lista de movimientos posibles: arriba ( (-1, 0) ), abajo( (1,
# 0) ), izquierda ( (0, -1) ), derecha ( (0, 1) ).
# A continuacion un ejemplo de una posible entrada y salida de la solucion:

#  Entrada                         Salida
#  Laberinto (matriz)              Camino para salir del laberinto: 1,1,1,2,
...
def resolver_laberinto(laberinto, fila, columna, camino = None):
    ...
    #caso base ////// si ya nos encontramos en la salida
    ...
    for movimiento in movimientos:
        ...
        if resultado:
            return resultado
    return None #NO hay solucion desde esta posicion
...
camino_solucion = resolver_laberinto(laberinto, 0, 0) # [0, 0], [1, 0], [1, 1], [1, 2], [0, 2], [0, 3], [0, 4], [1, 4], [2, 4], [2, 3]

if camino_solucion:
    print("Camino para salir del laberinto: ")
